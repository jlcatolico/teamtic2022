...
const AcercaDeNosotros = () => {
	return (
		<div className='bg-gradient-to-br from-white via-white to-red-300'>
			<section className='w-auto h-full m-0 p-0'>
			...
			<section className='bg-red relative flex items-center justify-between mt-20'>
				<div className='w-full'>
					<div className='px-6'>
