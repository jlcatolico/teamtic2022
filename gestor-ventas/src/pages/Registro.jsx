                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
                    ...
                    <div className="w-full pt-6 pb-1 z-20">
                        ...
                        <div className="py-6 space-x-2">
                            <a href="">
                                <span className="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg text-black border-2 border-black">f</span>
                            </a>
                            <a href="">
                                <span className="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg text-black border-2 border-black">G+</span>
                            </a>
                            <a href="">
                                <span className="w-10 h-10 items-center justify-center inline-flex rounded-full font-bold text-lg text-black border-2 border-black">in</span>
                            </a>
                        </div>
                        ...
                        <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            <div className="pb-2 pt-4">
                                <input type="text" name="nombres" placeholder="Nombres" className="block w-full p-4 text-lg rounded-sm bg-black"/>
                            </div>
                            <div className="pb-2 pt-4">
                                <input type="text" name="Apellidos" placeholder="Apellidos" className="block w-full p-4 text-lg rounded-sm bg-black"/>
                            </div>
                            <div className="pb-2 pt-4">
                                <input type="email" name="email" id="email" placeholder="Email" className="block w-full p-4 text-lg rounded-sm bg-black"/>
                            </div>
                            <div className="pb-2 pt-4">
                                <input type="email" name="email" id="email" placeholder="Confirm your Email" className="block w-full p-4 text-lg rounded-sm bg-black"/>
                            </div>
                            <span className="pt-4 flex justify-start text-lg text-black">Fecha de nacimiento</span>
                            <div className="pb-2 pt-0">
                                <input type="date" name="Fecha de Nacimiento" placeholder="Fecha de nacimiento" className="block w-full p-4 text-lg rounded-sm bg-black"/>
                            </div>
                            <div className="pb-2 pt-4">
                                <select name="OS" className="rounded-md border-black flex justify-start w-full p-4 text-lg bg-black">
                                    <option value="0" disabled='true'>Sexo</option>
                            ...
                            <div className="pb-2 pt-4">
                                <input type="password" name="clave" placeholder="Password" className="block w-full p-4 text-lg rounded-sm bg-black"/>
                            </div>
                            <div className="pb-2 pt-4">
                                <input className="block w-full p-4 text-lg rounded-sm bg-black" type="password" name="password" id="password" placeholder="Confirm Password"/>
                            </div>
