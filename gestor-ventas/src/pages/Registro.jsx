        ...
        <section className="min-h-screen flex items-stretch text-white ">
          ...
          >
            ...
            <div className="w-full px-24 z-10">
              <h1 className="text-5xl border-gray-300 font-bold text-left tracking-wide">
                Gestor de Ventas
              </h1>
          ...
          <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
            ...
            <div className="w-full pt-2 pb-1 z-20">
              <h1 className="my-3">
                <img
                  className="w-auto h-28 inline-flex"
                  src={DesarrolloIT_completo}
                  alt="GESTOR DE VENTAS"
                />
              ...
              <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                ...
                <span className="pt-4 flex justify-start text-lg text-black">
                  Fecha de nacimiento
                </span>
