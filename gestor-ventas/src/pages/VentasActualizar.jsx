          ...
          <form action="#">
            <div className="shadow overflow-hidden sm:rounded-md p-3">
              ...
              <div className=" md:w-1/4 px-3">
                <label className=" tracking-wide text-gray-700 mb-2" htmlFor="">
                  Id Venta
                </label>
                <input className="w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-1 px-4 mb-3"
                  id="id_venta" type="text" placeholder="33456" disabled='true'/>
              </div>
              <div className=" md:w-1/4 px-3">
                <label className=" tracking-wide text-gray-700 mb-2" htmlFor="">
                  Fecha Venta
                </label>
                <input className="w-full bg-gray-100 text-gray-500 border border-gray-200 rounded py-1 px-4 mb-3"
                  id="fecha_venta" type="date" placeholder="10/03/2021" disabled='true'/>
              </div>
              <div className=" md:w-2/4 px-3">
                <label className=" tracking-wide text-gray-700 mb-2" htmlFor="">
                  Estado Venta
                </label>
                <select id="estado" name="estado" autoComplete="estado" className="w-full px-2 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              ...
              <div className="-mx-3 md:flex mb-1">
                <div className="md:w-1/4 px-3">
                  ...
                  <input className="w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-1 px-4 mb-3"
                    id="id_cliente" type="text" placeholder="102345721 " disabled='true'/>
                </div>
                <div className="md:w-3/4 px-3 mb-6 md:mb-0">
                  ...
                  <input className="w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-1 px-4 mb-3"
                    id="nombre_cliente" type="text" placeholder="ANDRES CAMILO LOPEZ" disabled='true'/>
                </div>
              </div>
              <div className="-mx-3 md:flex mb-1">
                <div className="md:w-1/2 px-3 mb-3 md:mb-0">
                  ...
                  <input className="w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-1 px-4 mb-3"
                    id="direccion_cliente" type="text" placeholder="CARRERA 10D 33-13 PISO 4" disabled='true'/>
                </div>
                ...
                <div className="md:w-1/2 px-3">
                  ...
                  <input className="w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-1 px-4 mb-3"
                    id="email_cliente" type="text" placeholder="ANDRES.LOPEZ@GMAIL.COM" disabled='true'/>
                </div>
              </div>
              ...
              <div className="-mx-3 md:flex mb-3">
                <div className="md:w-1/4 px-3">
                  ...
                  <input className="w-full bg-gray-100 text-gray-700 border rounded py-1 px-4 mb-3"
                    id="id_vendedor" type="text" placeholder="4055" disabled='true'/>
                </div>
                <div className="md:w-3/4 px-3 mb-6 md:mb-0">
                  <label className="tracking-wide text-gray-700 mb-2" htmlFor="">
                    Nombre
                  ...
                  <input className="w-full bg-gray-100 text-gray-700 border rounded py-1 px-4 mb-3"
                    id="company" type="text" placeholder="DIEGO RAMIREZ" disabled='true'/>
                </div>
              </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th scope="col" className="px-6 py-3 text-right font-medium text-gray-500 tracking-wider">
                        Cantidad
                      </th>
                      <th scope="col" className="px-6 py-3 text-right font-medium text-gray-500 tracking-wider">
                        Precio Unitario
