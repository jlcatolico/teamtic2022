...
const VentasCrear = () => {
    return (
        <>
            <div className="mx-8 md:grid md:grid-cols-1 md:gap-6">
                <div className="grid-rows-2 grid-cols-1 h-screen ">
                    ...
                    <form action="#">
                        <div className="shadow overflow-hidden sm:rounded-md">
                            ...
                            <div className=" md:w-1/6 col-span-6 sm:col-span-3 mb-5">
                                <label class="uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="">
                                    Id Venta
                                </label>
                                <input class="w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="33456" />
                                <div>
                                </div>
                            </div>
                            ...
                            <div class="-mx-3 md:flex mb-2">
                                <div class="md:w-1/4 px-3">
                                    ...
                                    <input class="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="102345721" />
                                    <div>
                                    </div>
                                </div>
                                ...
                                <div class="md:w-3/4 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="ANDRES CAMILO LOPEZ" />
                                    <div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="-mx-3 md:flex mb-5">
                                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="CARRERA 10D 33-13 PISO 4" />
                                    <div>
                                    </div>
                                </div>
                                ...
                                <div class="md:w-1/2 px-3">
                                    ...
                                    <input class="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="ANDRES.LOPEZ@GMAIL.COM" />
                                    <div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="-mx-3 md:flex mb-6">
                                <div class="md:w-1/6 px-3">
                                    ...
                                    <input class="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="4055" />
                                    <div>
                                    </div>
                                </div>
                                ...
                                <div class="md:w-5/6 px-3 mb-6 md:mb-0">
                                    ...
                                    <input class="w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3" id="company" type="text" placeholder="DIEGO RAMIREZ" />
                                    <div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Decripcion</th>
